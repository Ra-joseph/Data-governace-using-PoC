...
from app.api import datasets, git, subscriptions, semantic, orchestration, policy_authoring, policy_dashboard, policy_reports, policy_exchange, domain_governance, policy_conflicts, pr_governance
...
app.include_router(policy_exchange.router, prefix=settings.API_V1_PREFIX)
app.include_router(domain_governance.router, prefix=settings.API_V1_PREFIX)
app.include_router(policy_conflicts.router, prefix=settings.API_V1_PREFIX)
app.include_router(pr_governance.router, prefix=settings.API_V1_PREFIX)
